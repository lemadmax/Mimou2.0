	...
	: m_CameraController(glm::radians(70.0f), 3.0f/2.0f)
{
	...
	Ref<Texture> GridTexture = Texture2D::Create("Assets/Textures/duxin.jpg");
	...
	SquareObject->m_Transform.SetScale(glm::vec3(GridTexture->GetWidth() / 100, GridTexture->GetHeight() / 100, 1));
